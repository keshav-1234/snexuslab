<!DOCTYPE html>
<!-- Mirrored from static.laralink.com/html/prohealth/blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 04 Mar 2024 13:31:26 GMT -->
<head>
  <!-- Meta Tags -->
  <meta charset="utf-8">
...
<div class="cs_height_200 cs_height_xl_150 cs_height_lg_110"></div>
    <!-- Start Footer Banner  -->
    <section class="cs_footer_margin_0">
      <div class="container">
        <div class="cs_banner cs_style_9 cs_white_bg cs_radius_30">
          <div class="cs_banner_img"><img src="assets/img/doctors/banner_img_3.png" alt=""></div>
          <h2 class="cs_banner_title cs_fs_72">Don’t Let Your Health <br>Take a Backseat!</h2>
          <p class="cs_banner_subtitle cs_fs_20 m-0 cs_medium">Schedule an appointment with one of our experienced <br>medical professionals today!</p>
        </div>
      </div>
    </section>
    <!-- End Footer Banner  -->
            ...
            <div class="col-lg-4">
              <div class="cs_footer_item">
                <div class="cs_text_widget">
                  <p>SNEXUSLAB Medical & <br>Healthcare Center</p>
                </div>
                <ul class="cs_contact_widget">
                  <li>
                    ...
                    shop number 6, MA Durga apt, behind navjivan school, nalasopara east,401209, Maharashtra, India
                  </li>
                  <li>
                    <i class="cs_accent_bg">
                  ...
                  <li>
                    ...
                    <a href="https://static.laralink.com/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="046c6168686b6765686867616a706176446369656d682a676b69">snexuslab@gmail.com</a>
                  </li>
                </ul>
              </div>
            </div>
